...
class Maze:
    ...
    # def _break_walls(self):
        ...
        #     possible_neighbors = [neighbor for neighbor in neighbors if not self._cells[neighbor[0]][neighbor[1]].visited]
        #     if not possible_neighbors:
        #         continue
        #     new_i, new_j = random.choice(possible_neighbors)
        #     possible_neighbors.remove((new_i,new_j))
        #     if new_i==i:
        #         if new_j<j:
